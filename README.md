...
<div align ="center">
안녕하십니까 이번에 개발 역량을 확보하고자 인프런에서 주관하는 풀스택 프로젝트에 참여하여 
하단과 같은 내용들을 개발하였습니다. 현재 기본적인 환경 설정을 완료하였으며, 이후 Refactoring 과정을 통하여 코드를 수정하여 프로그램으로서 활용할 수 있도록 제작하도록 하겠습니다. 감사합니다!
</div>
